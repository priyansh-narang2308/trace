...
interface FeedItem {
  ...
  description: string;
  checkpointType: "MILESTONE" | "DEPLOYMENT" | "GIT_COMMIT" | "REVIEW";
...
const INITIAL_FEED: FeedItem[] = [
  {
    ...
    projectName: "Monad Hyper-DEX Protocol",
    checkpointHash: "0x8fa3910c49b82103e5f182c4019a8204918231aa3b23c1023941031c2049182b",
    description: "Milestone Anchor: Deployed ultra-low latency AMM pool router contract with 1-second finality integration on Monad Testnet (`Chain ID 10143`). Validated against 100,000 simulated swaps per second.",
    checkpointType: "DEPLOYMENT",
    creatorAddress: "0x71C...893B",
    timestamp: new Date(Date.now() - 1000 * 60 * 12).toISOString(),
    txHash: "0x4912048120481029481029481029481029481029481029481029481029481029",
    likes: 42,
  },
  {
    id: "feed-2",
    projectId: "trace-core",
    projectName: "TRACE Autonomous Enclave Engine",
    checkpointHash: "0x391841029481029481029481029481029481029481029481029481029481029a",
    description: "Git Commit & P-256 Signature Anchor: Optimized zero-knowledge proof verification pipeline for off-chain collaborator signatures. Reduced gas costs by 64% using secp256r1 precompile.",
    checkpointType: "MILESTONE",
    creatorAddress: "0x3A9...120E",
    timestamp: new Date(Date.now() - 1000 * 60 * 45).toISOString(),
    txHash: "0x9182049182049182049182049182049182049182049182049182049182049182",
    likes: 88,
  },
  {
    id: "feed-3",
    projectId: "gmove-sdk",
    projectName: "G-Move Parallel Engine",
    checkpointHash: "0x728104918204918204918204918204918204918204918204918204918204918f",
    description: "Sub-Second State Snapshot: Synchronized 14 co-signers across decentralized nodes with instant cryptographic attestation.",
  ...
  {
    id: "feed-4",
    projectId: "monad-nft-studio",
    projectName: "Monad generative Enclave Studio",
    checkpointHash: "0x102948102948102948102948102948102948102948102948102948102948102c",
    description: "Milestone Verified: Completed full security audit for P-256 precompile multi-sig treasury lockbox contract.",
    checkpointType: "REVIEW",
    creatorAddress: "0x51E...901A",
    timestamp: new Date(Date.now() - 1000 * 60 * 240).toISOString(),
    txHash: "0x8102948102948102948102948102948102948102948102948102948102948102",
    likes: 156,
  },
];
...
export function SocialFeed() {
  ...
  const loadMore = () => {
    ...
    setTimeout(() => {
      const moreItems: FeedItem[] = [
        {
          id: `feed-${Date.now()}-1`,
          projectId: "parallel-evm-bridge",
          projectName: "Parallel EVM High-Throughput Bridge",
          checkpointHash: `0x${Math.random().toString(16).slice(2, 10)}${Math.random().toString(16).slice(2, 10)}9012841029481029481029481029481`,
          description: "Micro-Checkpoint: Staged state commitment with 1-second finality anchor across Monad validator node ring.",
          checkpointType: "GIT_COMMIT",
          creatorAddress: "0x481...209B",
          timestamp: new Date().toISOString(),
          txHash: `0x${Math.random().toString(16).slice(2, 10)}${Math.random().toString(16).slice(2, 10)}8102948102948102948102948102948`,
          likes: Math.floor(Math.random() * 50) + 10,
        },
      ];
      setItems((prev) => [...prev, ...moreItems]);
      setIsLoadingMore(false);
      toast.success("Loaded newer live milestones from Monad Testnet!");
    }, 800);
  };
