import { NftBadgeMatrix } from "@/components/achievements/nft-badge-matrix";
        ...
        <div className="max-w-[1200px] mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <span className="font-mono text-[13px] text-coral-pulse flex items-center gap-1.5 font-medium">
              ...
              <span>Monad NFT Badge Matrix</span>
            </span>
          </div>
        ...
        <div className="p-6 rounded-[20px] bg-ink border border-border shadow-key flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[12px] font-mono text-ash flex items-center gap-1">
                ...
                <span>Verified via Monad Secp256r1 P-256 Precompile (`0x0100`)</span>
              </span>
            </div>
            <h1 className="text-[32px] font-medium tracking-tight text-pure-white font-sans">
              Decentralized Contribution Badges
            </h1>
            <p className="text-[14px] font-mono text-mist max-w-2xl leading-[1.6]">
              Every sub-second anchor, verified git commit, and multi-sig co-signer attestation on Monad Testnet builds your verifiable developer reputation and unlocks soulbound NFT badges.
            </p>
          </div>
          ...
          <div className="p-4 rounded-xl bg-obsidian border border-border shrink-0 font-mono text-[13px] space-y-2">
            <div className="flex items-center justify-between gap-4 text-ash">
              ...
              <span className="text-electric-sky font-bold">`0x0100...NFT`</span>
            </div>
            <div className="flex items-center justify-between gap-4 text-ash">
              <span>Precompile Type:</span>
              <span className="text-emerald-verify font-bold">`P-256 Enclave`</span>
            </div>
            <div className="flex items-center justify-between gap-4 text-ash">
              <span>Minting Fee:</span>
              <span className="text-pure-white font-bold">`0.00001 MON`</span>
            </div>
          </div>
        </div>
